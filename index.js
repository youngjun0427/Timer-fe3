...
const timerStart = () => {
  ...
  // 웹페이지의 특정 부분을 주기적으로 업데이트해줘야 하거나, 어떤 API로 부터 변경된 데이터를 주기적으로 받아와야 하는 경우가 있는데요. 이럴 때 사용
  ...
  timer = setInterval(() => {
    ...
    // 초가 0 이 됐을 때 분이 1 이상이면 분을 --; 하고 초를 60초로 할당. // 고쳐야댈듯
    ...
    // 시간이 1 이상일때 시간을 제외한 분, 초가 0 일 경우 시간을 하나 줄이고 분과 초에 59 할당
